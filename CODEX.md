...
3. Check you're on the correct branch from PRD `branchName`. If not, check it out or create from main or master.
...
The source of truth of this repository is ./docs/full-specs.md file. It contains the whole project specs. You can use it to gain the context if you need it.
