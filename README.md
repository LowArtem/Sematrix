...
- The `frontend` container now builds the Vite React SPA and serves the compiled bundle from Nginx, with same-origin `/api` requests proxied to the backend container.
